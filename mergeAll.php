<?php
    ...
    $response1 = getContents("http://jayasuryapinaki.me/actions/getTopFiveDetails.php");
    ...
    for ($i=0; $i < 7; $i++) { 
    	// echo $i;
	    $topFive = array_merge($response1[$i], $response2[$i], $response3[$i]);
